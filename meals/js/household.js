  ...
  document.body.innerHTML = `
    <div style="max-width:480px;margin:15vh auto;padding:32px;font-family:-apple-system,sans-serif;text-align:center;">
      ...
      <p style="color:#7A6A5A;font-size:14px;line-height:1.6;">
        Open <code>meals/js/firebase-config.js</code> and paste in your Firebase project's config
        (see <code>meals/README.md</code> for the full setup steps), then reload this page.
      </p>
    </div>`;
}
